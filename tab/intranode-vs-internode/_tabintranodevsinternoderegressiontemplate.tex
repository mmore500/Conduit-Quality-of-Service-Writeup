...
\csvstyle{myTableStyle}{
  ...
  table head=\caption{
    Full \regression{} results of quality of service metrics against log processor count for weak scaling experiment (Section \ref{sec:weak-scaling}).
    Listed results include both piecewise and complete regression.
  ...
  }\label{tab:intranode-vs-internode-\regressionslug} \\
    \toprule%
