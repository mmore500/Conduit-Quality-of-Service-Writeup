...
\csvstyle{myTableStyle}{
  ...
  table head=\caption{
      With lac-417 vs. sans lac-417 ~ \regression.
    }\label{tab:with-lac-417-vs-sans-lac-417-\metricslug-\regressionslug} \\
    \toprule%
...
\renewcommand\filename{\detokenize{subtree/conduit-binder/binder/date=2021+project=72k5n/a=with-lac-417-vs-sans-lac-417/outplots/a=with_lac_417_vs_sans_lac_417_regression_results+async_mode=3+comp_work=0+impl=proc+nproc=256+nthread=1+proc=0-255+readability=latexcsvreader+replicate=0-9+slurm_nnodes=256+slurm_ntasks=256+subject=inlet~outlet+view=summary+ext=.csv}}
\catcode`\%=14
