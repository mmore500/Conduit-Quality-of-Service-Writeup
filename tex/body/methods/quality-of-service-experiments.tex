...
Because the underlying system runns in real-time while being observed, state changes can occur during data collection (somewhat akin to photographic motion blur).
